...
export default function ShoppingCarousel2() {
  ...
  const products = [
    {
      ...
      name:'Audio',
      title: "Skin care",
      image: "https://m.media-amazon.com/images/I/61OFfAjyX2L._SL1500_.jpg",
      price: "Under ₹499",
    },
    {
      id: 2,
    ...
    },
    {
      id: 3,
      name:'Electronics',
      title: "City Furniture, Home...",
      image: "https://dreamlineoutdoorfurniture.com/cdn/shop/products/Granton_2_-_Person_Seating_Group_with_Cushions_1.png?v=1660642718&width=1080",
      price: "Under ₹499",
    },
    {
      id: 4,
      ...
      image: "https://supplysix.com/cdn/shop/files/Catalog_5.jpg?v=1719408472&width=800",
      price: "Under ₹499",
    },
    {
      id: 5,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 relative">
      <h2 className="text-2xl font-bold mb-4">Beauty Auto & more</h2>
